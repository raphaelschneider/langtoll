export const metadata = {
  ...
  description: 'How LangPass handles your data: learning data stays on your device, the apps you lock are invisible even to us, AI processing is transient, telemetry is anonymous. No accounts, no tracking.',
  ...
  return (
    <main style={{ minHeight: '100vh', background: C.paper, padding: '64px 24px', fontFamily: 'var(--font-inter), ui-sans-serif, system-ui' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <p style={S.p}>
          LangPass locks the apps that distract you until you practice a language. This policy describes
        ...
        <p style={S.p}>
          Everything LangPass records about you — your name and passenger details, chosen language and
        ...
        <p style={S.p}>
          LangPass blocks distracting apps using Apple’s Screen Time (Family Controls) framework. When
          you choose which apps to lock, iOS records that choice as a privacy-preserving token that only
          the system can read. LangPass never receives the names or identities of the apps you selected,
        ...
        <ul style={{ paddingLeft: 22 }}>
          <li style={S.li}>
            <strong style={{ color: C.ink }}>AI topic packs (Plus).</strong> When you ask LangPass to
          ...
          <li style={S.li}>
            ...
            request comes from a genuine, unmodified copy of LangPass. It contains no personal data and
        ...
        <p style={S.p}>
          ...
          subscription provider. To know whether LangPass Plus is active, the app sends Apple’s purchase
        ...
        <h2 style={S.h2}>8. Who operates LangPass, and your rights</h2>
        <p style={S.p}>
          LangPass is operated from Germany; the operator of LangPass is the controller for the limited
        ...
        <div style={{ borderTop: `1px solid ${C.line}`, marginTop: 40, paddingTop: 16, fontSize: 13, color: C.soft }}>
          LangPass is a language-learning app. See our <a href="/terms" style={{ color: C.accent }}>Terms of Use</a>.
        </div>
      </div>
    </main>
  );
