...
export const A2_VOCAB: VocabItem[] = [
  ...
  // ── city & services ───────────────────────────────────────────────────
  { id: 'fr2v111', de: 'la banque', en: ['the bank'], gloss: { de: ['die Bank'], es: ['el banco'], it: ['la banca'], pt: ['o banco'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v112', de: 'la poste', en: ['the post office'], gloss: { de: ['die Post'], es: ['la oficina de correos'], it: ['la posta'], pt: ['os correios'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v113', de: 'la pharmacie', en: ['the pharmacy', 'the chemist’s'], gloss: { de: ['die Apotheke'], es: ['la farmacia'], it: ['la farmacia'], pt: ['a farmácia'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v114', de: 'la bibliothèque', en: ['the library'], gloss: { de: ['die Bibliothek'], es: ['la biblioteca'], it: ['la biblioteca'], pt: ['a biblioteca'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v115', de: 'le musée', en: ['the museum'], gloss: { de: ['das Museum'], es: ['el museo'], it: ['il museo'], pt: ['o museu'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v116', de: 'le parc', en: ['the park'], gloss: { de: ['der Park'], es: ['el parque'], it: ['il parco'], pt: ['o parque'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v117', de: 'le quartier', en: ['the neighbourhood', 'the district'], gloss: { de: ['das Viertel'], es: ['el barrio'], it: ['il quartiere'], pt: ['o bairro'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v118', de: 'le pont', en: ['the bridge'], gloss: { de: ['die Brücke'], es: ['el puente'], it: ['il ponte'], pt: ['a ponte'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v119', de: 'la place', en: ['the square'], gloss: { de: ['der Platz'], es: ['la plaza'], it: ['la piazza'], pt: ['a praça'] }, pos: 'noun', level: 'A2', category: 'city' },
  { id: 'fr2v120', de: 'l’immeuble', en: ['the building', 'the block of flats'], gloss: { de: ['das Gebäude'], es: ['el edificio'], it: ['il palazzo'], pt: ['o prédio'] }, pos: 'noun', gender: 'm', level: 'A2', category: 'city' },

  // ── directions ────────────────────────────────────────────────────────
  { id: 'fr2v121', de: 'tourner', en: ['to turn'], gloss: { de: ['abbiegen'], es: ['girar'], it: ['girare'], pt: ['virar'] }, pos: 'verb', level: 'A2', category: 'directions' },
  { id: 'fr2v122', de: 'traverser', en: ['to cross'], gloss: { de: ['überqueren'], es: ['cruzar'], it: ['attraversare'], pt: ['atravessar'] }, pos: 'verb', level: 'A2', category: 'directions' },
  { id: 'fr2v123', de: 'continuer', en: ['to continue', 'to carry on'], gloss: { de: ['weitergehen'], es: ['seguir'], it: ['continuare'], pt: ['continuar'] }, pos: 'verb', level: 'A2', category: 'directions' },
  { id: 'fr2v124', de: 'monter', en: ['to go up', 'to get on'], gloss: { de: ['hinaufgehen'], es: ['subir'], it: ['salire'], pt: ['subir'] }, pos: 'verb', level: 'A2', category: 'directions' },
  { id: 'fr2v125', de: 'descendre', en: ['to go down', 'to get off'], gloss: { de: ['hinuntergehen'], es: ['bajar'], it: ['scendere'], pt: ['descer'] }, pos: 'verb', level: 'A2', category: 'directions' },
  { id: 'fr2v126', de: 'à gauche', en: ['on the left'], gloss: { de: ['links'], es: ['a la izquierda'], it: ['a sinistra'], pt: ['à esquerda'] }, pos: 'phrase', level: 'A2', category: 'directions' },
  { id: 'fr2v127', de: 'à droite', en: ['on the right'], gloss: { de: ['rechts'], es: ['a la derecha'], it: ['a destra'], pt: ['à direita'] }, pos: 'phrase', level: 'A2', category: 'directions' },
  { id: 'fr2v128', de: 'tout droit', en: ['straight ahead'], gloss: { de: ['geradeaus'], es: ['todo recto'], it: ['sempre dritto'], pt: ['sempre em frente'] }, pos: 'phrase', level: 'A2', category: 'directions' },
  { id: 'fr2v129', de: 'en face de', en: ['opposite'], gloss: { de: ['gegenüber von'], es: ['enfrente de'], it: ['di fronte a'], pt: ['em frente de'] }, pos: 'prep', level: 'A2', category: 'directions' },
  { id: 'fr2v130', de: 'à côté de', en: ['next to', 'beside'], gloss: { de: ['neben'], es: ['al lado de'], it: ['accanto a'], pt: ['ao lado de'] }, pos: 'prep', level: 'A2', category: 'directions' },

  // ── weather ───────────────────────────────────────────────────────────
  { id: 'fr2v131', de: 'le temps', en: ['the weather'], gloss: { de: ['das Wetter'], es: ['el tiempo'], it: ['il tempo'], pt: ['o tempo'] }, pos: 'noun', level: 'A2', category: 'weather' },
  { id: 'fr2v132', de: 'la météo', en: ['the weather forecast'], gloss: { de: ['der Wetterbericht'], es: ['el pronóstico del tiempo'], it: ['le previsioni del tempo'], pt: ['a previsão do tempo'] }, pos: 'noun', level: 'A2', category: 'weather' },
  { id: 'fr2v133', de: 'le nuage', en: ['the cloud'], gloss: { de: ['die Wolke'], es: ['la nube'], it: ['la nuvola'], pt: ['a nuvem'] }, pos: 'noun', level: 'A2', category: 'weather' },
  { id: 'fr2v134', de: 'l’orage', en: ['the thunderstorm'], gloss: { de: ['das Gewitter'], es: ['la tormenta'], it: ['il temporale'], pt: ['a tempestade'] }, pos: 'noun', gender: 'm', level: 'A2', category: 'weather' },
  { id: 'fr2v135', de: 'la température', en: ['the temperature'], gloss: { de: ['die Temperatur'], es: ['la temperatura'], it: ['la temperatura'], pt: ['a temperatura'] }, pos: 'noun', level: 'A2', category: 'weather' },
  { id: 'fr2v136', de: 'le brouillard', en: ['the fog'], gloss: { de: ['der Nebel'], es: ['la niebla'], it: ['la nebbia'], pt: ['o nevoeiro'] }, pos: 'noun', level: 'A2', category: 'weather' },
  { id: 'fr2v137', de: 'pleuvoir', en: ['to rain'], gloss: { de: ['regnen'], es: ['llover'], it: ['piovere'], pt: ['chover'] }, pos: 'verb', level: 'A2', category: 'weather' },
  { id: 'fr2v138', de: 'neiger', en: ['to snow'], gloss: { de: ['schneien'], es: ['nevar'], it: ['nevicare'], pt: ['nevar'] }, pos: 'verb', level: 'A2', category: 'weather' },
  { id: 'fr2v139', de: 'ensoleillé', en: ['sunny'], gloss: { de: ['sonnig'], es: ['soleado'], it: ['soleggiato'], pt: ['ensolarado'] }, pos: 'adj', level: 'A2', category: 'weather' },
  { id: 'fr2v140', de: 'humide', en: ['damp', 'humid'], gloss: { de: ['feucht'], es: ['húmedo'], it: ['umido'], pt: ['úmido'] }, pos: 'adj', level: 'A2', category: 'weather' },

  // ── phone & technology ────────────────────────────────────────────────
  { id: 'fr2v141', de: 'le portable', en: ['the mobile phone'], gloss: { de: ['das Handy'], es: ['el móvil'], it: ['il cellulare'], pt: ['o celular'] }, pos: 'noun', level: 'A2', category: 'technology' },
  { id: 'fr2v142', de: 'l’écran', en: ['the screen'], gloss: { de: ['der Bildschirm'], es: ['la pantalla'], it: ['lo schermo'], pt: ['a tela'] }, pos: 'noun', gender: 'm', level: 'A2', category: 'technology' },
  { id: 'fr2v143', de: 'le mot de passe', en: ['the password'], gloss: { de: ['das Passwort'], es: ['la contraseña'], it: ['la password'], pt: ['a senha'] }, pos: 'noun', level: 'A2', category: 'technology' },
  { id: 'fr2v144', de: 'le message', en: ['the message'], gloss: { de: ['die Nachricht'], es: ['el mensaje'], it: ['il messaggio'], pt: ['a mensagem'] }, pos: 'noun', level: 'A2', category: 'technology' },
  { id: 'fr2v145', de: 'le courriel', en: ['the email'], gloss: { de: ['die E-Mail'], es: ['el correo electrónico'], it: ['l’email'], pt: ['o e-mail'] }, pos: 'noun', level: 'A2', category: 'technology' },
  { id: 'fr2v146', de: 'l’application', en: ['the app'], gloss: { de: ['die App'], es: ['la aplicación'], it: ['l’applicazione'], pt: ['o aplicativo'] }, pos: 'noun', gender: 'f', level: 'A2', category: 'technology' },
  { id: 'fr2v147', de: 'le site web', en: ['the website'], gloss: { de: ['die Webseite'], es: ['el sitio web'], it: ['il sito web'], pt: ['o site'] }, pos: 'noun', level: 'A2', category: 'technology' },
  { id: 'fr2v148', de: 'le clavier', en: ['the keyboard'], gloss: { de: ['die Tastatur'], es: ['el teclado'], it: ['la tastiera'], pt: ['o teclado'] }, pos: 'noun', level: 'A2', category: 'technology' },
  { id: 'fr2v149', de: 'télécharger', en: ['to download'], gloss: { de: ['herunterladen'], es: ['descargar'], it: ['scaricare'], pt: ['baixar'] }, pos: 'verb', level: 'A2', category: 'technology' },
  { id: 'fr2v150', de: 'envoyer', en: ['to send'], gloss: { de: ['schicken'], es: ['enviar'], it: ['inviare'], pt: ['enviar'] }, pos: 'verb', level: 'A2', category: 'technology' },

  // ── free time & sport ─────────────────────────────────────────────────
  { id: 'fr2v151', de: 'le sport', en: ['the sport'], gloss: { de: ['der Sport'], es: ['el deporte'], it: ['lo sport'], pt: ['o esporte'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v152', de: 'le match', en: ['the match', 'the game'], gloss: { de: ['das Spiel'], es: ['el partido'], it: ['la partita'], pt: ['a partida'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v153', de: 'l’équipe', en: ['the team'], gloss: { de: ['die Mannschaft'], es: ['el equipo'], it: ['la squadra'], pt: ['a equipe'] }, pos: 'noun', gender: 'f', level: 'A2', category: 'leisure' },
  { id: 'fr2v154', de: 'la piscine', en: ['the swimming pool'], gloss: { de: ['das Schwimmbad'], es: ['la piscina'], it: ['la piscina'], pt: ['a piscina'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v155', de: 'le vélo', en: ['the bicycle'], gloss: { de: ['das Fahrrad'], es: ['la bicicleta'], it: ['la bicicletta'], pt: ['a bicicleta'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v156', de: 'la musique', en: ['the music'], gloss: { de: ['die Musik'], es: ['la música'], it: ['la musica'], pt: ['a música'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v157', de: 'le film', en: ['the film', 'the movie'], gloss: { de: ['der Film'], es: ['la película'], it: ['il film'], pt: ['o filme'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v158', de: 'le concert', en: ['the concert'], gloss: { de: ['das Konzert'], es: ['el concierto'], it: ['il concerto'], pt: ['o concerto'] }, pos: 'noun', level: 'A2', category: 'leisure' },
  { id: 'fr2v159', de: 'nager', en: ['to swim'], gloss: { de: ['schwimmen'], es: ['nadar'], it: ['nuotare'], pt: ['nadar'] }, pos: 'verb', level: 'A2', category: 'leisure' },
  { id: 'fr2v160', de: 'courir', en: ['to run'], gloss: { de: ['laufen'], es: ['correr'], it: ['correre'], pt: ['correr'] }, pos: 'verb', level: 'A2', category: 'leisure' },

  // ── plans & modal verbs ───────────────────────────────────────────────
  { id: 'fr2v161', de: 'le projet', en: ['the plan', 'the project'], gloss: { de: ['das Projekt'], es: ['el proyecto'], it: ['il progetto'], pt: ['o projeto'] }, pos: 'noun', level: 'A2', category: 'plans' },
  { id: 'fr2v162', de: 'le rendez-vous', en: ['the appointment'], gloss: { de: ['der Termin'], es: ['la cita'], it: ['l’appuntamento'], pt: ['o compromisso'] }, pos: 'noun', level: 'A2', category: 'plans' },
  { id: 'fr2v163', de: 'la date', en: ['the date'], gloss: { de: ['das Datum'], es: ['la fecha'], it: ['la data'], pt: ['a data'] }, pos: 'noun', level: 'A2', category: 'plans' },
  { id: 'fr2v164', de: 'espérer', en: ['to hope'], gloss: { de: ['hoffen'], es: ['esperar'], it: ['sperare'], pt: ['esperar'] }, pos: 'verb', level: 'A2', category: 'plans' },
  { id: 'fr2v165', de: 'décider', en: ['to decide'], gloss: { de: ['entscheiden'], es: ['decidir'], it: ['decidere'], pt: ['decidir'] }, pos: 'verb', level: 'A2', category: 'plans' },
  { id: 'fr2v166', de: 'préférer', en: ['to prefer'], gloss: { de: ['bevorzugen'], es: ['preferir'], it: ['preferire'], pt: ['preferir'] }, pos: 'verb', level: 'A2', category: 'plans' },
  { id: 'fr2v167', de: 'pouvoir', en: ['to be able to', 'can'], gloss: { de: ['können'], es: ['poder'], it: ['potere'], pt: ['poder'] }, pos: 'verb', level: 'A2', category: 'plans' },
  { id: 'fr2v168', de: 'devoir', en: ['to have to', 'must'], gloss: { de: ['müssen'], es: ['deber'], it: ['dovere'], pt: ['dever'] }, pos: 'verb', level: 'A2', category: 'plans' },
  { id: 'fr2v169', de: 'savoir', en: ['to know', 'to know how to'], gloss: { de: ['wissen'], es: ['saber'], it: ['sapere'], pt: ['saber'] }, pos: 'verb', level: 'A2', category: 'plans' },
  { id: 'fr2v170', de: 'réserver', en: ['to book', 'to reserve'], gloss: { de: ['reservieren'], es: ['reservar'], it: ['prenotare'], pt: ['reservar'] }, pos: 'verb', level: 'A2', category: 'plans' },
];
