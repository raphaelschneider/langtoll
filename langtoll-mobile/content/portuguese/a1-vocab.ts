...
export const A1_VOCAB: VocabItem[] = [
  ...
  { id: 'pv007', speakerGender: 'm', altAnswers: ['obrigada'], de: 'obrigado', en: ['thank you (said by men)'], gloss: { de: ['danke (sagen Männer)'], es: ['gracias (dicen los hombres)'], fr: ['merci (disent les hommes)'], it: ['grazie (dicono gli uomini)'] }, pos: 'phrase', level: 'A1', category: 'greetings' },
  { id: 'pv007b', speakerGender: 'f', altAnswers: ['obrigado'], de: 'obrigada', en: ['thank you (said by women)'], gloss: { de: ['danke (sagen Frauen)'], es: ['gracias (dicen las mujeres)'], fr: ['merci (disent les femmes)'], it: ['grazie (dicono le donne)'] }, pos: 'phrase', level: 'A1', category: 'greetings' },
