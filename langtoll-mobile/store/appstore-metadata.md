...
LANGTOLL PLUS:
Start with 7 days of Plus, free. If you let it lapse, the lock and the whole A1 course stay yours at no cost. Plus opens the route: A2 to B2, your words riding the Dynamic Island all day, unlimited apps and whole categories behind the gate, any fare you like, strict mode with zero grace, the studio voice, the full curriculum, and AI packs for your world and your goal — say "pass the B1 exam" and every session carries exam material.
...
- Subtitle: `Lernen entsperrt deine Apps` (27)
...
- Subtitle: `Aprende y desbloquea tus apps` (29)
...
- Subtitle: `Apprends et débloque tes apps` (29)
...
- Subtitle: `Impara e sblocca le tue app` (27)
...
- Subtitle: `Aprenda e libere seus apps` (26)
