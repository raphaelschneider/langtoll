...
export const de: Partial<Record<StringKey, string>> = {
  ...
  'settings.voiceCompact': 'Dein iPhone nutzt nur die einfache {lang}-Stimme. Eine natürliche gibt es gratis zum Laden.',
  'settings.voiceMissing': 'Auf deinem iPhone ist keine {lang}-Stimme installiert — Wörter können noch nicht vorgelesen werden.',
  'settings.voicePath': 'iPhone-Einstellungen → Bedienungshilfen → Gesprochene Inhalte → Stimmen → Sprache wählen und eine erweiterte oder Premium-Stimme laden.',
