...
export const en = {
  ...
  'home.activityOff': 'Your pass countdown is missing from the Lock Screen — Live Activities are off. Tap to turn them back on.',
  'settings.liveActivities': 'Lock Screen countdown',
  'settings.laEnabled': 'Enabled — your pass shows on the Lock Screen and Dynamic Island',
