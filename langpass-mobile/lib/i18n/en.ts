...
export const en = {
  ...
  'ob.mirrorTitle': "That's what those apps take. Every day.",
  'ob.mirrorTitleNamed': "{name}, that's what those apps take. Every day.",
  ...
  'ob.pay3d': 'Spanish and French land in Plus first.',
  ...
  'settings.voiceDetail': 'Read German out loud as you practice',
